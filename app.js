/* CBLE Exam Simulator, Application Logic */

const ACCESS_CODE  = "CBLE9000";
const EXAM_SECONDS = 16200;
const PASSING_PCT  = 75;
const STORAGE_KEY  = "cble_exam_state_v1";
const SIM_Q_COUNT  = 80;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"entry_and_entry_summary_procedures": "Entry and Entry Summary Procedures", "tariff_classification_and_the_htsus": "Tariff Classification and the HTSUS", "valuation_appraisement_and_duty_assessment": "Valuation Appraisement and Duty Assessment", "broker_compliance_recordkeeping_and_penalties": "Broker Compliance Recordkeeping and Penalties", "bonds_warehouses_and_foreign_trade_zones": "Bonds Warehouses and Foreign Trade Zones", "country_of_origin_marking_and_intellectual_property_rights": "Country of Origin Marking and Intellectual Property Rights", "quota_trade_agreements_and_drawback": "Quota Trade Agreements and Drawback", "practical_exercises_and_general_broker_duties": "Practical Exercises and General Broker Duties"};  // maps domain key -> human-readable label for display
